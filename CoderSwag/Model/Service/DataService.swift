...
class DataService {
    ...
    private let shirts =
        [Product(title: "Devslopes Logo Shirt Black", price: "$24", imageName: "shirt01.png"),
         ...
         Product(title: "Kickflip Studios Black", price: "$24", imageName: "shirt05.png")]
    ...
    private let hats =
        [Product(title: "Devslopes Logo Graphic Beanie", price: "$16", imageName: "hat01.png"),
